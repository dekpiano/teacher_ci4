        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">แบบประเมินการอ่าน คิดวิเคราะห์ และเขียน (ปีการศึกษา <?= $term ?>/<?= $academicYear ?>)</h3>
                </div>
                <div class="card-body">
                    <?php if ($assessmentStatus !== 'on') : ?>
                        <div class="alert alert-danger text-center" role="alert">
                            <h4 class="alert-heading"><i class="bi bi-exclamation-triangle-fill me-2"></i>ปิดระบบ</h4>
                            <p>ระบบการประเมินการอ่าน คิดวิเคราะห์ และเขียน ถูกปิดการใช้งานชั่วคราว</p>
                        </div>
                    <?php endif; ?>
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer bg-transparent border-top-0">
                                            <div class="d-grid gap-2 d-sm-flex justify-content-sm-end">
                                                <a href="<?= base_url('teacher/reading_assessment/assess/' . $class['Reg_Class']) ?>" class="btn btn-primary <?= $isDisabled ? 'disabled' : '' ?>" <?= $isDisabled ? 'aria-disabled="true"' : '' ?>>
                                                    <i class="bi bi-pencil-square me-1"></i> ประเมิน
                                                </a>
                                                <a href="<?= base_url('teacher/reading_assessment/print_report/' . $class['Reg_Class']) ?>" target="_blank" class="btn btn-info <?= $isDisabled ? 'disabled' : '' ?>" <?= $isDisabled ? 'aria-disabled="true"' : '' ?>>
