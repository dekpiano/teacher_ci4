                            ...
                            <?php foreach ($teacherClasses as $class) : ?>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                    <div class="small-box text-bg-info">
                                        ...
                                        <a href="<?= base_url('teacher/reading_assessment/print_report/' . $class['Reg_Class']) ?>" target="_blank" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
