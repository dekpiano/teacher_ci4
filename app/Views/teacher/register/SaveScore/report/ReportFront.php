    ...
    <tbody>
        ...
        <tr>
            <td colspan="5" style="width: 45.2832%;"><strong>ร้อยละของนักเรียนที่ได้ผลการเรียนระดับดี(3)
                    ขึ้นไป&nbsp;</strong></td>
            <td style="width: 8.0208%; text-align: center; vertical-align: middle;"><strong>
                <?=number_format($avg3_up, 2, '.', '');?>
            </strong></td>
            <td colspan="5" style="width: 37.1541%;"><strong>ผลการเรียนเฉลี่ยของรายวิชา</strong></td>
            <td style="width: 8.1773%; text-align: center; vertical-align: middle;">
            <strong>
                <?=number_format($avgSubject, 2, '.', '')?>
            </strong>
        </td>
        </tr>
        <tr>
            <td colspan="5" style="width: 45.2832%;"><strong>ร้อยละของนักเรียนที่ไม่ผ่านการประเมิน</strong></td>
            <td style="width: 8.0208%; text-align: center; vertical-align: middle;">
            <strong>
                <?=number_format($avg_NoPass, 2, '.', '');?>
            </strong>
        </td>
