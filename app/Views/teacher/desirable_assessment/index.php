                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer bg-transparent border-top-0">
                                            <div class="d-grid gap-2 d-sm-flex justify-content-sm-end">
                                                <a href="<?= base_url('teacher/desirable_assessment/assess/' . $class['Reg_Class']) ?>" class="btn btn-primary">
                                                    <i class="bi bi-pencil-square me-1"></i> ประเมิน
                                                </a>
                                                <a href="<?= base_url('teacher/desirable_assessment/print_report/' . $class['Reg_Class']) ?>" target="_blank" class="btn btn-info">
